...
export class CustomerFormComponent implements OnInit {
  ...
  private loadUsers() {
    this.userService.searchUsers('', 200).subscribe(list => this.users = list);
  }
  ...
  onSubmit() {
    ...
    // 🔥 Evitamos enviar null al backend
    const raw = this.form.getRawValue();
    const dto = {
      ...raw,
      userId: raw.userId || undefined, // ✅ si es null o vacío → undefined
    };
